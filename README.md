...
[`ccprompts`](https://github.com/ursisterbtw/ccprompts) by [ursisterbtw](https://github.com/ursisterbtw) ⚖️ MIT  
A repository of curated production-ready prompt templates for Claude AI designed to help developers extend AI-powered automation across the software development lifecycle including bootstrap testing refactoring CI/CD and security.
